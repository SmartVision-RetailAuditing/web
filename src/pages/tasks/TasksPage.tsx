...
const KpiCard: React.FC<KpiCardProps> = ({ icon, label, sub, value, color, loading, onClick }) => (
  <div
    onClick={onClick}
    className={`bg-white p-5 rounded-xl border border-gray-100 shadow-sm flex items-center gap-4 ${onClick ? 'cursor-pointer hover:border-orange-200 hover:shadow-md transition-all' : ''}`}
  >
      ...
      <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm space-y-3">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="relative flex-1 max-w-md">
            ...
            <input
              type="text"
              placeholder="Search tasks, stores or assignee..."
              value={searchTerm}
          ...
          <div className="relative">
            ...
            <select
              ...
              className="pl-8 pr-8 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-700 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 appearance-none cursor-pointer"
            >
              <option value="">All Priorities</option>
              {PRIORITY_OPTIONS.map(o => (
                <option key={o.value} value={['LOW','MEDIUM','HIGH'][o.value]}>
                  {o.label}
                </option>
              ))}
            </select>
          ...
          <div className="relative">
            ...
            >
              ...
              {TASK_TYPE_OPTIONS.map(o => (
                <option
                  key={o.value}
                  value={Object.keys(TASK_TYPE_LABELS)[o.value]}
                >
                  {o.label}
                </option>
              ))}
                    ...
                    <tr key={task.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        {task.assigneeId && task.assigneeName ? (
                          ...
                          <button
                            onClick={() => setAssignTask({ id: task.id, storeName: task.storeName })}
